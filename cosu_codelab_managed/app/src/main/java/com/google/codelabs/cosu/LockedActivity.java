...
public class LockedActivity extends Activity {
    ...
    // keep devices from locking using with the keyguard
    // disable the status bar 
    // keep a device screen on while plugged in 
    // set default user restrictions
    // ensure your app is launched on reboot by setting it as the default launcher 
    private ComponentName mAdminComponentName;
    // mAdminComponentName => indicates which DeviceAdminReceiver is associated
    @Override
